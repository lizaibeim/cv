...
\begin{document}
    ...
    \begin{list}{\textbullet}{\setlength{\leftmargin}{1.2em}
        ...
        \item Developed CoLA (\href{https://ucph-cola.org}{ucph-cola.org}), an egocentric wearable platform integrating real-time multimodal sensing and Human-AI collaboration for learning analytics.
    \end{list}
    \vspace{0.8em}
    ...
    \begin{list}{\textbullet}{\setlength{\leftmargin}{1.2em}
                   ...
                   \setlength{\itemsep}{\listitemspace}
                   \setlength{\parsep}{\listitemspace}}
        \item Integrated prior prototypes into OpenMMLA, an IoT-based multimodal toolkit with reusable end-to-end data pipelines for collaborative behavior analysis.
        \item Developed interactive workflows and pipeline components for multimodal sensing, optimizing data synchronization, sensor fusion, and transparent behavioral analysis.
    \end{list}
    \vspace{0.8em}
    ...
    \begin{itemize}
        ...
        \item \textbf{CoLA}: An egocentric wearable platform for real-time multimodal sensing and Human-AI collaboration in learning analytics, \href{https://ucph-cola.org}{\textcolor{blue}{\textit{link}}}
