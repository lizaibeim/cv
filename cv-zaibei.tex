...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item \textbf{CoLA}: An egocentric wearable platform for real-time multimodal sensing and Human-AI interaction in collaborative learning analytics, \href{https://ucph-cola.org}{\textcolor{blue}{\textit{link}}}
