...
\begin{document}
    ...
    \begin{itemize}
        \item Multimodal learning analytics: multimodal sensing, educational data mining, and human-AI collaboration
        \item Ubiquitous computing: Internet of Things, system design, and mobile computing
        \item Interactive systems: data visualization, user interface design, and human-computer interaction
    \end{itemize}
    ...
    \begin{tablist}
        ...
        \item[2025] \tab{}Meta Project Aria Research Partnership / Hardware Grant
